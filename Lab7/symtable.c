...
* Date: 10 / 20 / 2022
* Purpose: this is a C program that contains code for our symbol table 
*
* Recent changes made:
* 2022-10-22: create a global temporary variable 
*/
...
char *TEMP_CREATE()
{
	...
	GTEMP++; // increment temp
	return(strdup(s)); // return duplicate
} // end TEMP_CREATE
...
void PrintSym(struct SymbTab *s)
{
	char *string,*display_type; 
	 ...
	 switch(s->Type) {
		 ...
		 case A_Decaf_ARRAY: display_type = "ARRAY " ; break;
