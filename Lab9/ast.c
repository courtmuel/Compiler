...
* Date: 10 / 30 / 2022 
* Purpose: this is a C program that contains an abstract syntax tree for our lab7
*
* Changes made:
* 2022-10-23: create a new method to check formal parameters
* 2022-10-30: create pre and post conditons for ALL methods / functions present even if not modified
* 2022-10-30: changed some of the print statements to present Coopers outputs in cases for ASTprint
*/
